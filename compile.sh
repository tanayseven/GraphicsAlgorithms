...
echo "gcc -o ${1:0:len}.o \`pkg-config --cflags --libs gtk+-3.0\` DrawingWindow.c LineDrawing.c $1 "

#actually runs the command, if errors will be echoed here
gcc -o ${1:0:len}.o `pkg-config --cflags --libs gtk+-3.0` DrawingWindow.c LineDrawing.c $1 
